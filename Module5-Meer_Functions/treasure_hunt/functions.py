...
from data import JOURNEY_IN_DAYS, COST_FOOD_HUMAN_COPPER_PER_DAY, COST_FOOD_HORSE_COPPER_PER_DAY, friends, COST_HORSE_SILVER_PER_DAY, COST_TENT_GOLD_PER_WEEK
import math
